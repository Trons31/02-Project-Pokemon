...
import {localFavorites, PokeGetStatic} from '../../utils';
...
const PokemonPage: NextPage<Props> = ({ pokemon }) => {
  ...
  const [inInFavorites, setinInFavorites] = useState( localFavorites.existInFavorites( pokemon.id) );

  const onToogleClik = () => {
    localFavorites.toggleFavorites( pokemon.id )
    setinInFavorites(!inInFavorites);

    if (inInFavorites ) return;
                ...
                <Card>
                  <Card.Header css={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Button
                      color="gradient"
                      ghost={ !inInFavorites }
                      onClick={ onToogleClik }
                    >
                      { inInFavorites ? 'En favoritos' : 'Guardar en favoritos' }
                    </Button>
                  </Card.Header>
